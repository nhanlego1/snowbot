...
/* themes/snowbot/templates/field/field--paragraph--h1-text.html.twig */
class __TwigTemplate_e97366eeda7198eee7604c883f4a37252be68b392cd43e852272aa2008a6804e extends Twig_Template
{
...
";
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 65
                    echo "      <h1";
                    echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute((isset($context["attributes"]) ? $context["attributes"] : null), "addClass", array(0 => (isset($context["classes"]) ? $context["classes"] : null), 1 => "field--item centered"), "method"), "html", null, true));
                    echo ">";
                    echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute($context["item"], "content", array()), "html", null, true));
                    echo "</h1>
    ";
...
";
    ...
    {
        return "themes/snowbot/templates/field/field--paragraph--h1-text.html.twig";
    }
...
{% if label_hidden %}
  ...
  {% else %}
    {% for item in items %}
      <h1{{ attributes.addClass(classes, 'field--item centered') }}>{{ item.content }}</h1>
    {% endfor %}
  {% endif %}
{% else %}
