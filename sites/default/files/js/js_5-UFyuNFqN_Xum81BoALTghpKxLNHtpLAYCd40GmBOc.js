...
!function(s,i,l,c){console.log(s(".slick__slide.slick-active").find(".has-color")),s(".slick__slide.slick-active").find(".has-color")?s(".slick-dots").addClass("dot-white"):s(".slick-dots").addClass("dot-blue"),s(".slick__arrow .slick-next,.slick__arrow .slick-prev").click(function(i){s(".slick__slide").each(function(i,l){s(this).hasClass("slick-active").find(".has-color")?s(".slick-dots").addClass("dot-white"):s(".slick-dots").addClass("dot-blue")})})}(jQuery,Drupal,this,this.document,this.app);;
/**
 * @file
